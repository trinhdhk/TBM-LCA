---
title: 'A novel scoring system for Tuberculous Meningitis Diagnosis: a Bayesian Latent Class Analysis Approach'
author:
...
knitr::opts_chunk$set(echo = FALSE, dpi=300, dev=params$dev) #, dev = 'png'
...
# m3 = new.env()
m3 = readRDS(file.path(data_dir, '..', 'export', 'metrics', 'm3.RDS')) |> as.environment()
# load(file.path(data_dir, '..', 'export', 'metrics', 'm3_calibROC.Rdata'), envir = zz)
load(file.path(data_dir, '..', 'export', 'm3_plot.Rdata'), envir = m3)
# m3$rocs = readRDS(file.path(data_dir, '..', 'export', 'metrics', 'm3_roc_iscb.RDS'))
# m3$calib = readRDS(file.path(data_dir, '..', 'export', 'metrics', 'm3_calib.RDS'))
# m3$roc = readRDS(file.path(data_dir, '..', 'export', 'metrics', 'm3_ROC.RDS'))
# m3_roc = readRDS(file.path(data_dir, '..', 'export', 'm3_roc.RDS')) 
# 3_calib = readRDS(file.path(data_dir, '..', 'export', 'm3_calib.RDS')) 
