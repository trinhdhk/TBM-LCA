...
s.t $RE$ is the individidual random effect, $b_{binary}$ and $b_{continuous}$ are the slopes corresponding for binary and continuous features, and $b_{RE}$ is the overall effect of bacillary burden on test results.
