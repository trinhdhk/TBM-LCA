...
```{r lkj, out.width='30%', fig.cap="Example density plot for $LKJCorrelationCholesky(\\eta=4)$ in bivariate case. 1 is perfect positive correlation, 0 is no correlation, and -1 is perfect negative correlation. Black dot, thick, and thin line are the median, IQR and 95% credible interval"}
ggplot() + 
...
-   Visualised model calibration between estimated predicted and observed probabilities of positive confirmation tests, using a non-parametric loess fit [@rms]. A model with good calibration would predict the risk near to the observed truth.
