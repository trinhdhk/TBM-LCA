...
\end{aligned}
$$
*where $Y$ is the observed test results whose prevalence is $\pi(Y)$, $z_0$ is the average positive rate; $b$ and $b_RE$ are the effects of $X'$ to $B$ and of $B$ to $\pi(Y)$, respectively.*
