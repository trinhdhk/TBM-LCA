...
Compared to the uniform case definition, we also made a change to **Past TB contact**, in which we hypothesise that by changing the question into "Past noticeable contact with TB patients within the past recent year", we would be able to imply all "Unknown" answer as a "No". In the main study, no brain imaging was taken, hence not included.
...
For imputation, $Normal(0,2.5)$ was chosen as prior distributions for all intercepts and coefficients [@prior-choice], except for LoGCS (E, V, and M) as their supports were two-sided constained (section \@ref(data-pre-processing)) - in which case, suitable Uniform distributions were chosen for the means, and Normal for standard deviations (appendix \@ref(appendix-details)).
