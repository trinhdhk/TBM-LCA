...
joindt <- plyr::join_all(
    list(
        ...
        baselp[, .(USUBJID, LUMBARDATE, APP_A, 
                   CSF_VOL= fcase(!is.na(as.numeric(TB_VOL)) & TB_VOL != "", as.numeric(TB_VOL),
                                 !is.na(as.numeric(CSFVOLUME)) & CSFVOLUME != "", as.numeric(CSFVOLUME),
                                 !is.na(as.numeric(CSFVOL)) & CSFVOL != "", as.numeric(CSFVOL),
                                 default=NA),
