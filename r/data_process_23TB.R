...
# setnames(hist, 'illness_duration', 'clin_illness_day')

neuro[, clin_nerve_palsy := CranialPalsy=='Yes']
# setnames(neuro, 'gcs_bl', 'clin_gcs')
...
maindt <- plyr::join_all(
  list(
    ...
    hist[,.(PatientCode, clin_illness_day=illness_duration, clin_symptoms, clin_contact_tb)],
