## Script to plot the result of pp_check.R script ##############
## Author: Trinh Dong
## Email: trinhdhk@oucru.org
###############################################################

### Parameter, ppc is the results of pp_check.R
ppc = readRDS('outputs/ppc_check.RDS')
### The original fit_object_with_r1k1.RDS
orig = readRDS('outputs/m3_t00_b345678_q7_r1_k1_3103.RDS')
