...
parameters {
  vector[N_pt] logitPc; //logit of prob latent classes
...
transformed parameters{
  ...
  vector<lower=0, upper=1>[N_pt] Pc = Phi(logitPc);
...
model {
  ...
  // C = 0
  b[1,1] ~ skew_normal(2.886, 3.923, -4);//to be change. for xpert.
  b[1,2] ~ skew_normal(3.023, 3.923, -4);//to be change. for culture.
  b[1,3] ~ skew_normal(2, 3.923, -2);
